  ...
  return (
    <div className="bg-[#F5F7FA] min-h-screen w-full p-[25px] md:pt-[30px] md:px-[40px] md:pb-0">
      <div className="bg-white w-full h-full rounded-[25px] px-5 md:px-[30px] py-[22px] md:py-[30px]">
        ...
        <div className="w-full flex justify-end mt-5 px-4">
          <button className="bg-[#1814F3] text-[15px] py-[11px] md:py-[14px] w-full md:w-auto px-[74px] font-medium text-white rounded-[9px]">
            Save
          </button>
        </div>
      </div>
